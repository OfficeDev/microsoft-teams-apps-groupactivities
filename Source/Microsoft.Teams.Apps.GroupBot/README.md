...
- In a terminal, navigate to `Microsoft.Teams.Apps.GroupBot`

    ```bash
    # change into project folder
    cd Microsoft.Teams.Apps.GroupBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Microsoft.Teams.Apps.GroupBot` folder
  - Select `Microsoft.Teams.Apps.GroupBot.csproj` file
